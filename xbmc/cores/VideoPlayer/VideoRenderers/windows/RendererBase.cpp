...
void CRendererBase::GetDebugInfo(int idx, std::string& format, std::string& meta_prim, std::string& meta_light)
{
  ...
  format =
      StringUtils::Format("Source: pixel: {} {}-bit, matrix: {}, transfer: {}, {} range, {}", pixel,
                          rb->bits, prim, transf, rb->full_range ? "full" : "limited",
