...
std::wstring CDisplayUtilWin32::GetCurrentDisplayName()
{
  MONITORINFOEXW mi{};
  mi.cbSize = sizeof(mi);
...
std::vector<DISPLAYCONFIG_PATH_INFO> CDisplayUtilWin32::GetDisplayConfigPaths()
{
...
std::optional<DisplayConfigId> CDisplayUtilWin32::GetCurrentDisplayTargetId()
{
...
std::optional<DisplayConfigId> CDisplayUtilWin32::GetDisplayTargetId(
...
HDR_STATUS CDisplayUtilWin32::SetDisplayHDRStatus(const DisplayConfigId& identifier, bool enable)
{
  LONG result{ERROR_SUCCESS};
...
HDR_STATUS CDisplayUtilWin32::GetDisplayHDRStatus(const DisplayConfigId& identifier)
{
