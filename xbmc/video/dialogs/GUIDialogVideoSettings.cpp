...
void CGUIDialogVideoSettings::InitializeSettings()
{
  ...
  if (g_application.GetAppPlayer().Supports(RENDERFEATURE_TONEMAP))
  {
    ...
    entries.push_back(TranslatableIntegerSettingOption(36557, VS_TONEMAPMETHOD_REINHARD_2));
    entries.push_back(TranslatableIntegerSettingOption(36558, VS_TONEMAPMETHOD_ACES));
